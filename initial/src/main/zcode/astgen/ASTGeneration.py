...
class ASTGeneration(ZCodeVisitor):
    ...
    # Visit a parse tree produced by ZCodeParser#prim_type.
    def visitPrim_type(self, ctx:ZCodeParser.Prim_typeContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ZCodeParser#array_declared.
    ...
    # Visit a parse tree produced by ZCodeParser#statement_block_if.
